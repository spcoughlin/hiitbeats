...
### file%3A%2F%2F%2FUsers%2Fseancoughlin%2Fprojects%2Fhiitbeats%2Fsrc%2Fbackend%2Fbuild.sbt:17: error: `)` expected but `string constant` found
...
scalaVersion := "2.13.12"  // You can use the version of Scala you're working with
